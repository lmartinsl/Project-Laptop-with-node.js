...
const server = http.createServer((req, res) => {
    ...
    // Renderiza Imagens
    //      Testa a extensão do pathName, caso verdadeiro, a imagem é renderizada 
...
server.listen(1337, '127.0.0.1', () => {
    console.log('Listening for requests now!'); // testing
});

replaceTemplate = (originalHtml, laptop) => { // renderiza elementos ao DOM
